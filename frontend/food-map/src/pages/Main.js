  ...
  return (
    <div>
        ...
        <div className='w-full px-[15vw] z-10 relative mt-[-15vh]'>
            ...
            If you are aware of any forageable food, please click the button below to add to our database! Whether you are a sustainable leader reporting your community orchard or a good sumaritan reporting a strawberry patch on the side of the road, the data you are providing will help connect free, healthy food with those in need.
            </h3>
            <button
