  ...
  return (
    <div>
      <div className="relative h-screen w-screen">
        ...
        <div className='w-full px-[5vw] md:px-[15vw] z-10 relative mt-[5vh] pb-5'>
          <div className="bg-[#1d1d1d] w-full h-auto md:h-[35vh] mt-[5vh] rounded-[5vw] md:rounded-[2vw] flex flex-col gap-[2vh] p-[6vw] md:p-[3vw] -mb-[5vh]">
            <h1 className='text-white text-[5vw] md:text-[2.5vw]'>Hack Duke</h1>
        ...
        <div className='w-full px-[5vw] md:px-[15vw] z-10 relative mt-[5vh] flex flex-col md:flex-row gap-[5vh] md:gap-[2vw]'>
          {/* Jack */}
          <div className="bg-[#1d1d1d] w-full h-auto md:h-[90vh] rounded-[5vw] md:rounded-[2vw] flex flex-col gap-[2vh] p-[6vw] md:p-[3.5vw]">
            <img
              src={"/jack.jpg"}
              alt="team member"
              className="w-[40vw] h-[30vh] md:w-[12vw] md:h-[22vh] object-cover rounded-md self-center"
            />
            <h1 className='text-white text-[5vw] md:text-[2vw] text-center md:text-left'>Jack Dupuy</h1>
            <h3 className='text-white text-[3.5vw] md:text-[1vw] leading-[5vw] md:leading-[1.5vw]'>
          ...
          <div className="bg-[#1d1d1d] w-full h-auto md:h-[90vh] rounded-[5vw] md:rounded-[2vw] flex flex-col gap-[2vh] p-[6vw] md:p-[3.5vw]">
            <img
              ...
              className="w-[40vw] h-[30vh] md:w-[12vw] md:h-[22vh] object-cover rounded-md self-center"
            />
            <h1 className='text-white text-[5vw] md:text-[2vw] text-center md:text-left'>Aaron Squire</h1>
            <h3 className='text-white text-[3.5vw] md:text-[1vw] leading-[5vw] md:leading-[1.5vw]'>
          ...
          <div className="bg-[#1d1d1d] w-full h-auto md:h-[90vh] rounded-[5vw] md:rounded-[2vw] flex flex-col gap-[2vh] p-[6vw] md:p-[3.5vw]">
            <img
              ...
              className="w-[40vw] h-[30vh] md:w-[12vw] md:h-[22vh] object-cover rounded-md self-center"
            />
            <h1 className='text-white text-[5vw] md:text-[2vw] text-center md:text-left'>Chris Verbaro</h1>
            <h3 className='text-white text-[3.5vw] md:text-[1vw] leading-[5vw] md:leading-[1.5vw]'>
